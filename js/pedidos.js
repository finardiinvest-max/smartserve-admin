...
function createOrderCard(order) {
    ...
    return `
        <div class="pedido-card-kanban">
            <div onclick="viewOrder('${order._id}')" style="cursor: pointer;">
                <div class="cliente-nome" style="font-size: 1.1em; font-weight: bold; margin-bottom: 8px;">${clienteNome}</div>
...
window.quickUpdateStatus = async function(id, newStatus, event) {
