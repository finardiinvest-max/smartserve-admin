...
function createOrderCard(order) {
    ...
    // Verificar se cliente existe e tem dados
    if (order.cliente) {
        console.log('Cliente existe:', order.cliente);
        if (order.cliente.nome) {
            clienteNome = order.cliente.nome;
            console.log('Nome encontrado:', clienteNome);
        } else {
            console.log('Nome não encontrado em order.cliente.nome');
        }
        if (order.cliente.telefone) {
            clienteTelefone = order.cliente.telefone;
        }
    } else {
        console.log('order.cliente não existe!');
    }
